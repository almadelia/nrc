...
set origin 0.0,0.5
set title "12 layers"
p [1:950] for [i=2:53] "12_eigen_950_15-nospin" u 1:(column(i)-3.2297326438631049) title "" w l
set size 0.5,0.5
set origin 0.5,0.5
set title "18 layers"
p [1:950] for [i=2:77] "18_eigen_950_15-nospin" u 1:(column(i)-4.1741168584095831) title "" w l
set size 0.5,0.5
set origin 0.0,0.0
set title "24 layers"
p [1:950] for [i=2:101] "24_eigen_950_15-nospin" u 1:(column(i)-4.1391329211983550) title "" w l
set size 0.5,0.5
set origin 0.5,0.0
set title "30 layers"
p [1:950] for [i=2:125] "30_eigen_950_15-nospin" u 1:(column(i)-4.8354442685783718) title "" w l
unset multiplot
#    EOF
